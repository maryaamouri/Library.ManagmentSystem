...
namespace Libro.Persistence.Migrations
{
    ...
    [Migration("20230909102024_editTransactionDbModel")]
    partial class editTransactionDbModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Libro.Persistence.DbModels.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BookId = new Guid("1c7c36bc-0637-4da8-b5aa-f085678268c2"),
                            AuthorId = new Guid("4f6bf45f-8954-4882-88d8-40b1b7eee27f"),
                        ...
                        new
                        {
                            BookId = new Guid("1a148993-4ed3-4aa4-806a-15e60d7cf51d"),
                            AuthorId = new Guid("4f6bf45f-8954-4882-88d8-40b1b7eee27f"),
                        ...
                        new
                        {
                            BookId = new Guid("ffac5c65-40e5-4f74-9341-2273baec2e74"),
                            AuthorId = new Guid("4f6bf45f-8954-4882-88d8-40b1b7eee27f"),
                        ...
                        new
                        {
                            BookId = new Guid("3482addf-f2bc-48a4-974e-25205504e64f"),
                            AuthorId = new Guid("7a7b6727-c07e-410d-b79d-def9fb359cb0"),
                        ...
                        new
                        {
                            BookId = new Guid("4c6b1e10-76a8-40fa-ab84-fff5968305bf"),
                            AuthorId = new Guid("4f6bf45f-8954-4882-88d8-40b1b7eee27f"),
